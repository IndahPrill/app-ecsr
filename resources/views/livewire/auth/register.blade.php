                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">Create Account e-CSR</h1>
                            </div>
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="first_name" type="text" class="form-control" placeholder="First Name" id="first_name" autofocus required>
                                    </div>
                                    @error('email') <div wire:key="form" class="invalid-feedback"> {{$message}} </div> @enderror
                                </div>
                                <!-- End of Form -->
                                <!-- Form -->
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model="last_name" type="text" class="form-control" placeholder="Last Name" id="last_name" autofocus required>
                                    </div>
                                    @error('email') <div wire:key="form" class="invalid-feedback"> {{$message}} </div> @enderror
                                </div>
                                <!-- End of Form -->
